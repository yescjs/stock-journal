          ...
          <section className="space-y-4 text-xs md:text-sm">
            ...
            >
              ...
              <p className="text-[10px] text-slate-400">
                이 잠금 기능은 기본적인 사생활 보호용입니다.
                브라우저 localStorage에만 저장되며, 아주 민감한
                정보는 다른 방법으로 관리하는 것을
                권장합니다.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-[10px] text-slate-400">
                JSON 백업에는 매매 기록과 종목별 현재가가 함께
                저장됩니다. 다른 브라우저에서 이 파일을
                불러오면 동일한 데이터로 복원됩니다.
              </p>
            </div>

            <p className="text-[10px] text-slate-400">
              이 서비스는 어디에도 업로드되지 않고, 이
              브라우저의 localStorage에만 저장됩니다. 브라우저
              캐시 삭제나 시크릿 모드에서는 데이터가 사라질 수
              있습니다.
            </p>
          </section>
        )}
